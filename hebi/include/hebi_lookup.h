...
void hebiCleanup();
/**
 * \brief Create a module with the given mac address.
 *
 ...
 * released when use is complete via the hebiModuleRelease function.
 * 
 ...
 */
HebiModulePtr hebiCreateModuleFromMac(HebiLookupPtr lookup, const HebiMacAddress* address, long timeout_ms);
/**
 * \brief Create a module with the given name and family.
 *
 * Blocking call which waits to get a pointer to a Module object with the
 * given parameters.  Times out after timeout_msec milliseconds. Must be
 * released when use is complete via the hebiModuleRelease function.
 ...
 * module object corresponding to the given parameters otherwise.
 */
HebiModulePtr hebiCreateModuleFromName(HebiLookupPtr lookup, const char* name, const char* family, long timeout_ms);
/**
 ...
 */
void hebiModuleRelease(HebiModulePtr module);
/**
